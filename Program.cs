...
namespace Blackmail
{
    public partial class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddHttpClient("Blackmail.ServerAPI", client => client.BaseAddress = new Uri(builder.HostEnvironment.BaseAddress))
            ...
            builder.Services.AddScoped<BlackmailDbService>();
